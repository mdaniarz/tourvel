<x-layout.app title="Destination" activeMenu="destination" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Destination" :breadcrumbs="[
                ...
                <div class="row g-3 justify-content-between align-items-center">
                    @can('destination create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('destinations.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                hx-get="{{ route('destinations.index') }}"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari destination...</span>
                    </div>
                </div>

                <div id="destination-table">
                    @include('destination.includes.index-table', compact('destination'))
                </div>
            </div>
        </div>
    </div>

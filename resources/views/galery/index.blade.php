<x-layout.app title="Galery" activeMenu="galery" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Galery" :breadcrumbs="[
                ...
                <div class="row g-3 justify-content-between align-items-center">
                    @can('galery create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('galeries.create') }}" class="btn btn-primary w-100 w-md-fit">
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari galery...</span>
                    </div>
                </div>

                <div id="galery-table">
                    @include('galery.includes.index-table', compact('galery'))
                </div>
            </div>
        </div>
    </div>
